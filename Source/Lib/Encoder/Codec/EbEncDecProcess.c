...
void md_sq_motion_search_controls(ModeDecisionContext *mdctxt, uint8_t md_sq_mv_search_level) {
    ...
    case 1:
...
#if TEST_LEVEL_1
        md_sq_motion_search_ctrls->sparse_search_level_0_area_width       = 175;
        md_sq_motion_search_ctrls->sparse_search_level_0_area_height      = 175;
#elif TEST_LEVEL_2
        md_sq_motion_search_ctrls->sparse_search_level_0_area_width       =  125;
        md_sq_motion_search_ctrls->sparse_search_level_0_area_height      =  125;
#else
        ...
        md_sq_motion_search_ctrls->sparse_search_level_1_area_width       =  25;
        md_sq_motion_search_ctrls->sparse_search_level_1_area_height      =  25;
